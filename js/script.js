...
const iam = document.querySelector(".school-info-btn")
iam.addEventListener("click", () => {
    document.querySelector(".school-info-block").style.display = "block"
})

const  iamcl = document.querySelector(".school-info-btn1")
iamcl.addEventListener("click", () => {
    document.querySelector(".school-info-block").style.display = "none"
})


const hamburger = document.querySelector(".open-hamburger-menu-ion")
hamburger.addEventListener("click", () => {
    document.querySelector(".hamburger-menu").style.display = "block"
})

const  hamburgerClose = document.querySelector(".close-hamburger-menu-ion")
